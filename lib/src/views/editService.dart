...
class EditService extends StatefulWidget {
  ...
  EditService({this.refresh, this.service});
  @override
  _AddProductState createState() => new _AddProductState();
}

class _AddProductState extends State<EditService> {
  ...
  @override
  void initState() {
    serviceImage = widget.service.serviceImage;
    _categoryValue = widget.service.catId;
    categoryName = widget.service.categotyName;
    _storeValue = widget.service.resId;
    storeName = widget.service.storeName;
    priceUnit = widget.service.priceUnit;
    _nameController.text = widget.service.serviceName;
    _decController.text = widget.service.serviceDescription;
    _priceController.text = widget.service.servicePrice;
  ...
  _apicall() async {
    ...
    var request =
        http.MultipartRequest('POST', Uri.parse('${baseUrl()}/edit_service'));
